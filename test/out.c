...
struct struct_3 test_testModule_maybeEven();
...
#ifndef ORANGE_PROGRAM_31356
#define ORANGE_PROGRAM_31356
...
struct struct_1 string_14 = {10, (char[]){'w', 'o', 'r', 'k', 'i', 'n', 'g', '.', '.', '.', '\0'}};
struct struct_1 string_15 = {10, (char[]){'<', 's', 't', 'd', 'l', 'i', 'b', '.', 'h', '>', '\0'}};
struct struct_1 string_16 = {9, (char[]){'<', 's', 't', 'd', 'i', 'o', '.', 'h', '>', '\0'}};
struct struct_1 string_17 = {10, (char[]){'<', 's', 't', 'd', 'i', 'n', 't', '.', 'h', '>', '\0'}};
struct struct_1 string_18 = {11, (char[]){'<', 's', 't', 'd', 'b', 'o', 'o', 'l', '.', 'h', '>', '\0'}};
...
int64_t test_testModule_main(struct struct_2 _args)
{
	...
	int64_t _0;
// AST_FOR
// test/testModule.orng:12
begin_37:;
	bool _1 = 1;
	if (!_1) goto end_37;
// AST_CALL
// test/testModule.orng:10
	struct struct_1 _2 = string_14;
	int64_t _3 = std_system_println(_2);
// AST_DEFINE
// test/testModule.orng:11
	int64_t _4;
	struct struct_3 _5 = test_testModule_maybeEven();
	if (_5.tag == 0) goto else_0;
	_4 = _5.something;
	goto end_1;
else_0:;
	goto end_37;
end_1:;
	...
	_6.tag = 1;
	_6.something = _4;
	struct struct_3 _37_y = _6;
	// for post
	goto begin_37;
end_37:;
// AST_INT
// test/testModule.orng:13
	int64_t _7 = 0;
	_0 = _7;
	retval = _0;
return_block_35:;
