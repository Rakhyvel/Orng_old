...
#ifndef ORANGE_PROGRAM_11374
#define ORANGE_PROGRAM_11374
...
struct struct_1 string_54 = {10, (char[]){'<', 's', 't', 'd', 'l', 'i', 'b', '.', 'h', '>', '\0'}};
struct struct_1 string_55 = {9, (char[]){'<', 's', 't', 'd', 'i', 'o', '.', 'h', '>', '\0'}};
struct struct_1 string_56 = {10, (char[]){'<', 's', 't', 'd', 'i', 'n', 't', '.', 'h', '>', '\0'}};
struct struct_1 string_57 = {11, (char[]){'<', 's', 't', 'd', 'b', 'o', 'o', 'l', '.', 'h', '>', '\0'}};
...
void test_leetcode_test_isPalindrome()
{
	int64_t _0;
// AST_DEFINE
// test/leetcode.orng:410
	int64_t _1 = 121;
	int64_t _140_x = _1;
// AST_DEFINE
// test/leetcode.orng:412
	bool _2 = test_leetcode_isPalindrome(_140_x);
	bool _140_ans = _2;
// AST_IF
// test/leetcode.orng:418
	int64_t _3;
	bool _4 = _140_ans;
	if (!_4) goto else_141;
	int64_t _5;
// AST_CALL
// test/leetcode.orng:415
...
// test/leetcode.orng:402
	struct struct_6* _7 = _130_list;
	int64_t _8 = _7->val;
	struct struct_6* _9 = _130_reversedList;
	int64_t _10 = _9->val;
	bool _11 = _8 != _10;
	if (!_11) goto else_133;
	bool _12;
// AST_RETURN
// test/leetcode.orng:401
	bool _13 = 0;
	retval = _13;
...
// AST_DEFINE
// test/leetcode.orng:403
	struct struct_6* _15 = _130_list;
	struct struct_7 _16 = _15->next;
	struct struct_7 _134_next = _16;
// AST_IF
// test/leetcode.orng:403
	struct struct_6* _17;
	struct struct_7 _18 = _134_next;
	bool _19 = _18.tag != 0;
	if (!_19) goto else_135;
	struct struct_6* _20;
// AST_DOT
// test/leetcode.orng:403
	struct struct_7 _21 = _134_next;
	struct struct_6* _22 = _21.something;
	_20 = _22;
	_17 = _20;
	goto end_135;
else_135:;
...
// AST_DEFINE
// test/leetcode.orng:404
	struct struct_6* _26 = _130_reversedList;
	struct struct_7 _27 = _26->next;
	struct struct_7 _137_next = _27;
// AST_IF
// test/leetcode.orng:404
	struct struct_6* _28;
	struct struct_7 _29 = _137_next;
	bool _30 = _29.tag != 0;
	if (!_30) goto else_138;
	struct struct_6* _31;
// AST_DOT
// test/leetcode.orng:404
	struct struct_7 _32 = _137_next;
	struct struct_6* _33 = _32.something;
	_31 = _33;
	_28 = _31;
	goto end_138;
else_138:;
...
// AST_IDENT
// test/leetcode.orng:404
	struct struct_6* _35 = _130_reversedList;
	_34 = _35;
	_28 = _34;
end_138:;
	_25 = _28;
	_130_reversedList = _25;
	_6 = _25;
	_4 = _6;
	// for post
	goto begin_132;
...
// test/leetcode.orng:451
	...
	struct struct_1 _153_s = _1;
// AST_DEFINE
// test/leetcode.orng:452
	struct struct_1 _2 = string_37;
	struct struct_1 _153_p = _2;
// AST_DEFINE
// test/leetcode.orng:454
	bool _3 = test_leetcode_isMatch(_153_s, _153_p);
	bool _153_ans = _3;
// AST_IF
...
bool test_leetcode_isMatch(struct struct_1 _s, struct struct_1 _p)
{
	...
	bool _0;
// AST_DEFINE
// test/leetcode.orng:428
	int64_t _1 = 0;
	int64_t _143_i = _1;
// AST_DEFINE
// test/leetcode.orng:429
	int64_t _2 = 0;
	int64_t _143_j = _2;
// AST_FOR
...
// test/leetcode.orng:445
	...
	_24 = _36;
over_0:;
	if (!_24) goto else_148;
// AST_IF
// test/leetcode.orng:439
	bool _37 = _145_repeat;
	if (!_37) goto else_149;
	int64_t _38;
// AST_ADD_ASSIGN
// test/leetcode.orng:436
	int64_t _39 = 1;
	_143_j += _39;
	_38 = _39;
	goto end_149;
...
// test/leetcode.orng:441
	...
	_143_i += _42;
// AST_IF
// test/leetcode.orng:444
	bool _43 = _145_repeat;
	bool _44 = !_43;
	if (!_44) goto else_152;
	int64_t _45;
// AST_ADD_ASSIGN
...
// test/leetcode.orng:479
	...
	struct struct_3 _160_height = _10;
// AST_DEFINE
// test/leetcode.orng:481
	int64_t _11 = 0;
	int64_t _12 = test_leetcode_maxArea(_160_height, _11);
	int64_t _160_ans = _12;
// AST_IF
// test/leetcode.orng:487
	int64_t _13;
	int64_t _14 = _160_ans;
	int64_t _15 = 49;
	bool _16 = _14 == _15;
	if (!_16) goto else_161;
	int64_t _17;
// AST_CALL
// test/leetcode.orng:484
...
else_161:;
	int64_t _20;
// AST_CALL
// test/leetcode.orng:486
	struct struct_1 _21 = string_42;
	int64_t _22 = std_system_println(_21, _160_ans);
	_20 = _22;
	_13 = _20;
end_161:;
	_0 = _13;
